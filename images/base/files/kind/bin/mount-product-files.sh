...
#
# [1] https://github.com/opencontainers/runtime-spec/blob/main/config.md#createcontainer-hooks
...
# system paths.
#
# See: https://github.com/nholuongut/kind/issues/2551
#
...
#
# [1] https://github.com/opencontainers/runtime-spec/blob/main/runtime.md#state
#
bundle=$(jq -r .bundle)
