...
If you have [go] 1.16+ and [docker], [podman] or [nerdctl] installed `go install https://github.com/nholuongut/kind@v0.24.0 && kind create cluster` is all you need!
...
You can install kind with `go install https://github.com/nholuongut/kind@v0.24.0`.
...
Current maintainers are [@anholuong] feel free to
