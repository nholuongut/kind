...
import (
	...
	"https://github.com/nholuongut/kind/pkg/internal/version"
)
...
func (a *action) Execute(ctx *actions.ActionContext) error {
	...
	// https://kubernetes.io/docs/setup/independent/create-cluster-kubeadm/#main-isolation
	if len(allNodes) == 1 {
		...
		// https://github.com/nholuongut/kind/issues/1699
		...
		if kubeVersion.LessThan(version.MustParseSemantic("v1.24.0-alpha.1.592+370031cadac624")) {
			...
			taints = []string{"node-role.kubernetes.io/main-"}
			...
			taints = []string{"node-role.kubernetes.io/control-plane-", "node-role.kubernetes.io/main-"}
		} else {
