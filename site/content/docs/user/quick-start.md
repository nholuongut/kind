...
Pre-built binaries are available on our [releases page](https://github.com/nholuongut/kind/releases).
...
above you can install kind from source with `go install https://github.com/nholuongut/kind@{{< stableVersion >}}` or clone this repo
...
To install use: `go install https://github.com/nholuongut/kind@{{< stableVersion >}}`.
...
On Windows via Winget (https://github.com/microsoft/winget-pkgs/tree/main/manifests/k/Kubernetes/kind)
{{< codeFromInline lang="powershell" >}}
...
You can also set a specific Kubernetes version by setting the `node`'s container image. You can find available image tags on the [releases page](https://github.com/nholuongut/kind/releases). Please use the `sha256` shasum for your desired kubernetes version, as seen in this example:
...
[known issues]: /docs/user/known-issues
[releases]: https://github.com/nholuongut/kind/releases
[node image]: /docs/design/node-image
[base image]: /docs/design/base-image
[kind-example-config]: https://raw.githubusercontent.com/nholuongut/kind/main/site/content/docs/user/kind-example-config.yaml
[kubernetes]: https://github.com/nholuongut/kubernetes
...
[release notes]: https://github.com/nholuongut/kind/releases
